...
contract GoBrrr is Ownable, MinterRole  {
    ...
    function withdraw() external onlyMinter returns (bool) {
        ...
        //uint256 mtokensPerBlock = tokensPerBlock.mul(100); //3%->3/100
        //mtokensPerBlock = mtokensPerBlock.sub(mtokensPerBlock.mod(97));
        //mtokensPerBlock = mtokensPerBlock.div(97);
